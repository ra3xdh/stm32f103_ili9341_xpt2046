...
void ts_spi_setup(void) {
    ...
    rcc_periph_clock_enable(RCC_TS_SPI);
    gpio_set_mode(TS_SPI_PORT, GPIO_MODE_OUTPUT_50_MHZ ,GPIO_CNF_OUTPUT_ALTFN_PUSHPULL, TS_SCL_PIN | TS_MO_PIN); //F103
    gpio_set_mode(TS_SPI_PORT, GPIO_MODE_INPUT ,GPIO_CNF_INPUT_FLOAT, TS_MI_PIN); //F103
